...
REM
REM Generated by Vivado on Wed Nov 19 23:12:59 -0600 2025
...
echo "xvlog --incr --relax -L uvm -prj spi_controller_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj spi_controller_tb_vlog.prj -log xvlog.log
