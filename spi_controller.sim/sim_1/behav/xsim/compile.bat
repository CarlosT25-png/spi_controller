...
REM
REM Generated by Vivado on Fri Nov 14 22:42:18 -0600 2025
...
echo "xvlog --incr --relax -L uvm -prj fifo_buffer_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj fifo_buffer_tb_vlog.prj -log xvlog.log
